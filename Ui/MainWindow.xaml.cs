...
public partial class MainWindow : Window
{
	...
	// Раскрытая строка держит поток с микрофона, а окно не закрывается — оно прячется.
	// Свернуть её надо руками, иначе поток останется жить в фоне без единого зрителя.
	private void ToTray()
	{
		Devices.Collapse();
